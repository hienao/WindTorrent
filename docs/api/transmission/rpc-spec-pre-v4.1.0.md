> [!IMPORTANT]
> This document applies to Transmission versions earlier than 4.1.0, which use the legacy RPC protocol and older key naming.
>
> For Transmission 4.1.0 and later, see [rpc-spec-v4.1.0-plus.md](./rpc-spec-v4.1.0-plus.md).
