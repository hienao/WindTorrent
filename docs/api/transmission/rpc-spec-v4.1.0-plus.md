> [!IMPORTANT]
> Transmission 4.1.0 (`rpc_version_semver` 6.0.0) added support for the JSON-RPC 2.0 protocol and converted all RPC strings to snake_case.
>
...
>
> For Transmission versions earlier than 4.1.0, see [rpc-spec-pre-v4.1.0.md](./rpc-spec-pre-v4.1.0.md).
> Archived upstream reference: https://github.com/transmission/transmission/blob/4.0.6/docs/rpc-spec.md
